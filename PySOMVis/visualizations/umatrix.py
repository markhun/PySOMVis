...
class UMatrix(VisualizationInterface):
    ...
    def _activate_controllers(
        ...
        reference = pn.pane.Str(
            '<ul><li><b>U-Matrix:</b> Ultsch, A., and Siemon, H.P. "Kohonen\'s Self Organizing Feature Maps for Exploratory Data Analysis." In Proc. Intern. Neural Networks, 1990, pp. 305-308, Kluwer Academic Press, Paris, France.</li></ul>'
        )
